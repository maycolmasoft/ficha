...
class ffspExamenFisicoRegionalController extends ControladorBase{
    ...
    public function index(){
        ...
        $examen_fisico_regional = new ffspExamenFisicoRegionalModel();
        ...
        $nombre_controladores = "ffspExamenFisicoRegional";
        ...
        $this->view("ffspExamenFisicoRegional",array(
