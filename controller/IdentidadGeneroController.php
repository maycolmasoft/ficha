...
class IdentidadGeneroController extends ControladorBase{
    ...
    public function index(){
        ...
        $identidadg = new IdentidadGeneroModel();
        ...
        $nombre_controladores = "IdentidadGenero";
        ...
        $this->view("IdentidadGenero",array(
