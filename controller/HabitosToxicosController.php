...
class HabitosToxicosController extends ControladorBase{
    ...
    public function index(){
        ...
        $habitos_toxicos = new HabitosToxicosModel();
        ...
        $nombre_controladores = "HabitosToxicos";
        ...
        $this->view("HabitosToxicos",array(
