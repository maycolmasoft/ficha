...
class ffspPermisosRolesController extends ControladorBase{
	...
	public function index(){
		...
		if (isset(  $_SESSION['nombre_usuarios']) )
		{
			...
			$nombre_controladores = "ffspPermisosRoles";
			...
			if (!empty($resultPer))
			{
			    ...
			    $rol = new ffspRolesModel();
					...
					$this->view("ffspPermisosRoles",array(
	...
	public function InsertaPermisosRoles(){
		...
		$this->redirect("ffspPermisosRoles", "index");
		}
		else
		{
			$this->view("Error",array(
