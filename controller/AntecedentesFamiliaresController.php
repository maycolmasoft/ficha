...
class AntecedentesFamiliaresController extends ControladorBase{
    ...
    public function index(){
        ...
        $antecedentes_familiares = new AntecedentesFamiliaresModel();
        session_start();
        ...
        $nombre_controladores = "AntecedentesFamiliares";
        ...
        $this->view("AntecedentesFamiliares",array(
