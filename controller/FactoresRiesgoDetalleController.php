...
class FactoresRiesgoDetalleController extends ControladorBase{
	...
	public function index(){
	    ...
	    $factores_riesgo_detalle = new FactoresRiesgoDetalleModel();
		...
		$nombre_controladores = "FactoresRiesgoDetalle";
