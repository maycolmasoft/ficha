...
class ReporteFichaController extends ControladorBase{
    ...
    public function ReporteFicha(){
        ...
        */
        ...
        if(!empty($rsdatos_empleos_anteriores)){
        ...
        if($sexo=="2"){
            ...
            if(!empty($rsdatos_antecedentes_mujer)){
...
";
        ...
        if(!empty($rsdatos_examen_regional)){
        ...
        if(!empty($rsdatos_resultado_examen)){
        ...
        if(!empty($rsdatos_factores_riesgo)){
...
";
        ...
        if(!empty($rsdatos_metodo_familiar)){
