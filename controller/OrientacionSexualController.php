...
class OrientacionSexualController extends ControladorBase{
    ...
    public function index(){
        ...
        $orientacion_sexual = new OrientacionSexualModel();
        ...
        $nombre_controladores = "OrientacionSexual";
        ...
        $this->view("OrientacionSexual",array(
