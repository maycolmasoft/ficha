...
<html lang="es">
  ...
  <section class="content-header">
    ...
    <section class="content">
     ...
     <div class="box-header">
  		...
  		<div class="box-body">
			...
			<form id="frm_empleados" action="<?php echo $helper->url("Empleados","Index"); ?>" method="post" class="col-lg-12 col-md-12 col-xs-12">
            	 ...
            	 <div class="row">
           		...
           		<div class="row">
    			    <div class="col-xs-12 col-md-4 col-lg-4 " style="text-align: center; ">
    	                  ...
    	                  <a href="<?php echo $helper->url("Empleados","Index"); ?>" class="btn btn-danger">CANCELAR</a>
	                    </div>
   ...
   <script src="view/js/Empleados.js?0.1"></script> 
