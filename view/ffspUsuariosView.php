        ...
        <section class="content">
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="<?php echo $helper->url("ffspUsuarios","InsertaUsuarios"); ?>" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-xs-12">
                      ...
                      <?php } } else {?>                		    
                    		 ...
                    		 <div class="row">
                    		    ...
                    		    <div class="form-group">
                        		    ...
                        		    <div class="form-group">
                                                          <label for="clave_usuarios" class="control-label">Password:</label>
                                                          <input type="password" class="form-control" id="clave_usuarios" name="clave_usuarios" value="" placeholder="(password..)" maxlength="15">
                                                          <div id="mensaje_clave_usuarios" class="errores"></div>
                                    </div>
                        		    </div>
                        		    ...
                        		    <div class="form-group">
                                                          <label for="clave_usuarios_r" class="control-label">Repita Password:</label>
                                                          <input type="password" class="form-control" id="clave_usuarios_r" name="clave_usuarios_r" value="" placeholder="(password..)" maxlength="15">
                                                          <div id="mensaje_clave_usuarios_r" class="errores"></div>
                                    </div>
                                    </div>
                    	       </div>
  ...
  <script type="text/javascript">
   ...
   function load_usuarios(pagina){
     ...
     $.ajax({
               ...
               url: 'index.php?controller=ffspUsuarios&action=index10&search='+search,
               type: 'POST',
               data: con_datos,
               success: function(x){
                 $("#users_registrados").html(x);
                 $("#load_registrados").html("");
                 $("#tabla_usuarios_activos").tablesorter(); 
   ...
   function load_usuarios_inactivos(pagina){
     ...
     $.ajax({
               ...
               url: 'index.php?controller=ffspUsuarios&action=index11&search='+search,
               type: 'POST',
               data: con_datos,
               success: function(x){
        ...
        <script>
	       	...
	       	$(document).ready(function(){
						...
						$( "#cedula_usuarios" ).autocomplete({
		      				source: "<?php echo $helper->url("ffspUsuarios","AutocompleteCedula"); ?>",
		      				minLength: 1
		    			});
		
						$("#cedula_usuarios").focusout(function(){
		    				$.ajax({
		    					url:'<?php echo $helper->url("ffspUsuarios","AutocompleteDevuelveNombres"); ?>',
		    					type:'POST',
		    					dataType:'json',
