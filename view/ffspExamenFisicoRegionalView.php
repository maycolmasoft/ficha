  ...
  <section class="content-header">
    ...
    <section class="content">
     ...
     <div class="box-header">
  		...
  		<div class="box-body">
			<form id="frm_examen_fisico_regional" action="<?php echo $helper->url("ffspExamenFisicoRegional","Index"); ?>" method="post" class="col-lg-12 col-md-12 col-xs-12">
           	 <div class="row">
     ...
     <div class="box-header">
  		...
  		<div class="box-body">
			<form id="frm_examen_fisico_regional_detalle" action="<?php echo $helper->url("ffspExamenFisicoRegionalDetalle","Index"); ?>" method="post" class="col-lg-12 col-md-12 col-xs-12">
           	 <div class="row">
        		    <div class="col-xs-12 col-md-3 col-md-3 ">
            		    <div class="form-group">
           		...
           		<div class="row">
    			    <div class="col-xs-12 col-md-4 col-lg-4 " style="text-align: center; ">
    	                  ...
    	                  <a href="<?php echo $helper->url("ffspExamenFisicoRegionalDetalle","Index"); ?>" class="btn btn-danger">CANCELAR</a>
	                    </div>
	              </div>        		    
    		    </div>
           </form>
