    ...
    <section class="content">
     ...
     <div class="box-header">
  		...
  		<div class="box-body">
			...
			<form id="frm_Discapacidad" action="<?php echo $helper->url("Discapacidad","Index"); ?>" method="post" class="col-lg-12 col-md-12 col-xs-12">
		    	 ...
		    	 <div class="row">
           		...
           		<div class="row">
    			    <div class="col-xs-12 col-md-4 col-lg-4 " style="text-align: center; ">
    	                  ...
    	                  <a href="<?php echo $helper->url("Discapacidad","Index"); ?>" class="btn btn-danger">CANCELAR</a>
	                    </div>
...
function soloNumeros(e){
   ...
   <script src="view/js/Discapacidad.js?1.5"></script> 
