...
$template = file_get_contents('view/reportes/template/ReporteContinuidad.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteContinuidad.css'); // la ruta a tu css
