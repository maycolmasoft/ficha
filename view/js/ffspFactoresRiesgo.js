...
$("#frm_factores_riesgo").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ffspFactoresRiesgo&action=InsertaFactoresRiesgo",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editFactoresRiesgo(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ffspFactoresRiesgo&action=editFactoresRiesgo",
		type:"POST",
		dataType:"json",
		data:{fac_id:id}
	}).done(function(datos){
...
function delFactoresRiesgo(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspFactoresRiesgo&action=delFactoresRiesgo",
		type:"POST",
		dataType:"json",
		data:{fac_id:id}
	}).done(function(datos){		
...
function consultaFactoresRiesgo(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspFactoresRiesgo&action=consultaFactoresRiesgo",
		type:"POST",
