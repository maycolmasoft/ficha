...
$("#frm_Discapacidad").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Discapacidad&action=InsertaDiscapacidad",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editDiscapacidad(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=Discapacidad&action=editDiscapacidad",
		type:"POST",
		dataType:"json",
		data:{dis_id:id}
	}).done(function(datos){
...
function delDiscapacidad(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Discapacidad&action=delDiscapacidad",
		type:"POST",
		dataType:"json",
		data:{dis_id:id}
	}).done(function(datos){		
...
function consultaDiscapacidad(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Discapacidad&action=consultaDiscapacidad",
		type:"POST",
