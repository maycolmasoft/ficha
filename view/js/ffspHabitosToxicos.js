...
$("#frm_habitos_toxicos").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ffspHabitosToxicos&action=InsertaHabitosToxicos",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editHabitosToxicos(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ffspHabitosToxicos&action=editHabitosToxicos",
		type:"POST",
		dataType:"json",
		data:{hab_id:id}
	}).done(function(datos){
...
function delHabitosToxicos(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspHabitosToxicos&action=delHabitosToxicos",
		type:"POST",
		dataType:"json",
		data:{hab_id:id}
	}).done(function(datos){		
...
function consultaHabitosToxicos(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspHabitosToxicos&action=consultaHabitosToxicos",
		type:"POST",
