...
$("#frm_empleados").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=InsertaEmpleados",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editEmpleados(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=Empleados&action=editEmpleados",
		type:"POST",
		dataType:"json",
		data:{empl_id:id}
	}).done(function(datos){
...
function delEmpleados(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Empleados&action=delEmpleados",
		type:"POST",
		dataType:"json",
		data:{empl_id:id}
	}).done(function(datos){		
...
function consultaEmpleados(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Empleados&action=consultaEmpleados",
		type:"POST",
...
function cargaIdentidadGenero(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=cargaIdentidadGenero",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
...
function cargaDiscapacidad(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=cargaDiscapacidad",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
...
function cargaEmpresa(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=cargaEmpresa",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
...
function cargaOrientacionSexual(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=cargaOrientacionSexual",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
...
function cargaReligion(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=cargaReligion",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
...
function cargaSexo(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Empleados&action=cargaSexo",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
