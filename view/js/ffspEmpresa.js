...
$("#frm_empresa").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ffspEmpresa&action=InsertaEmpresa",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editEmpresa(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ffspEmpresa&action=editEmpresa",
		type:"POST",
		dataType:"json",
		data:{emp_id:id}
	}).done(function(datos){
...
function delEmpresa(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspEmpresa&action=delEmpresa",
		type:"POST",
		dataType:"json",
		data:{emp_id:id}
	}).done(function(datos){		
...
function consultaEmpresa(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspEmpresa&action=consultaEmpresa",
		type:"POST",
