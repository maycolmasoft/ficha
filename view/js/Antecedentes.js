...
$("#frm_antecedentes").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Antecedentes&action=InsertaAntecedentes",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editAntecedentes(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=Antecedentes&action=editAntecedentes",
		type:"POST",
		dataType:"json",
		data:{ante_id:id}
	}).done(function(datos){
...
function delAntecedentes(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Antecedentes&action=delAntecedentes",
		type:"POST",
		dataType:"json",
		data:{ante_id:id}
	}).done(function(datos){		
...
function consultaAntecedentes(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Antecedentes&action=consultaAntecedentes",
		type:"POST",
...
function cargaSexoAntecedentes(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Antecedentes&action=cargaSexoAntecedentes",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
