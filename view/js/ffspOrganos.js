...
$("#frm_organo").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ffspOrganos&action=InsertaOrganos",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editOrganos(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ffspOrganos&action=editOrganos",
		type:"POST",
		dataType:"json",
		data:{org_id:id}
	}).done(function(datos){
...
function delOrganos(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspOrganos&action=delOrganos",
		type:"POST",
		dataType:"json",
		data:{org_id:id}
	}).done(function(datos){		
...
function consultaOrganos(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspOrganos&action=consultaOrganos",
		type:"POST",
