...
$("#frm_orientacion_sexual").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ffspOrientacionSexual&action=InsertaOrientacionSexual",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editOrientacionSexual(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ffspOrientacionSexual&action=editOrientacionSexual",
		type:"POST",
		dataType:"json",
		data:{ori_id:id}
	}).done(function(datos){
...
function delOrientacionSexual(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspOrientacionSexual&action=delOrientacionSexual",
		type:"POST",
		dataType:"json",
		data:{ori_id:id}
	}).done(function(datos){		
...
function consultaOrientacionSexual(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspOrientacionSexual&action=consultaOrientacionSexual",
		type:"POST",
