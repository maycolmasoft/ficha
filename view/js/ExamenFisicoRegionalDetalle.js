...
$("#frm_examen_fisico_regional_detalle").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ExamenFisicoRegionalDetalle&action=InsertaExamenFisicoRegionalDetalle",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editExamenFisicoRegionalDetalle(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ExamenFisicoRegionalDetalle&action=editExamenFisicoRegionalDetalle",
		type:"POST",
		dataType:"json",
		data:{exam_id:id}
	}).done(function(datos){
...
function delExamenFisicoRegionalDetalle(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPageDetalle").addClass("loader_detalle")},
		url:"index.php?controller=ExamenFisicoRegionalDetalle&action=delExamenFisicoRegionalDetalle",
		type:"POST",
		dataType:"json",
		data:{exam_id:id}
	}).done(function(datos){		
...
function consultaExamenFisicoRegionalDetalle(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPageDetalle").addClass("loader_detalle")},
		url:"index.php?controller=ExamenFisicoRegionalDetalle&action=consultaExamenFisicoRegionalDetalle",
		type:"POST",
...
function cargaExamenFisicoRegional(){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ExamenFisicoRegionalDetalle&action=cargaExamenFisicoRegional",
		type:"POST",
		dataType:"json",
		data:null
	}).done(function(datos){		
