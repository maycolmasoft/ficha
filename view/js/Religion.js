...
$("#frm_religion").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=Religion&action=InsertaReligion",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editReligion(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=Religion&action=editReligion",
		type:"POST",
		dataType:"json",
		data:{rel_id:id}
	}).done(function(datos){
...
function delReligion(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Religion&action=delReligion",
		type:"POST",
		dataType:"json",
		data:{rel_id:id}
	}).done(function(datos){		
...
function consultaReligion(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=Religion&action=consultaReligion",
		type:"POST",
