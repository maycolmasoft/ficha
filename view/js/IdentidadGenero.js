...
$("#frm_IdentidadGenero").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=IdentidadGenero&action=InsertaIdentidadGenero",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editIdentidadGenero(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=IdentidadGenero&action=editIdentidadGenero",
		type:"POST",
		dataType:"json",
		data:{ide_id:id}
	}).done(function(datos){
...
function delIdentidadGenero(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=IdentidadGenero&action=delIdentidadGenero",
		type:"POST",
		dataType:"json",
		data:{ide_id:id}
	}).done(function(datos){		
...
function consultaIdentidadGenero(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=IdentidadGenero&action=consultaIdentidadGenero",
		type:"POST",
