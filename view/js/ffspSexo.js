...
$("#frm_sexo").on("submit",function(event){
	...
	$.ajax({
		beforeSend:function(){},
		url:"index.php?controller=ffspSexo&action=InsertaSexo",
		type:"POST",
		dataType:"json",
		data:parametros
	}).done(function(datos){
...
function editSexo(id = 0){
	...
	$.ajax({
		...
		url:"index.php?controller=ffspSexo&action=editSexo",
		type:"POST",
		dataType:"json",
		data:{sex_id:id}
	}).done(function(datos){
...
function delSexo(id){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspSexo&action=delSexo",
		type:"POST",
		dataType:"json",
		data:{sex_id:id}
	}).done(function(datos){		
...
function consultaSexo(_page = 1){
	...
	$.ajax({
		beforeSend:function(){$("#divLoaderPage").addClass("loader")},
		url:"index.php?controller=ffspSexo&action=consultaSexo",
		type:"POST",
